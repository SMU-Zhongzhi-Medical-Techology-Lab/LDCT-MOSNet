...
class BaseEncoder(nn.Module):
    def __init__(self):
        ...
        self.block1 = InvertedResidualBlock(32,32,1,2)
        ...
        self.conv4 = nn.Conv2d(128,512,1,1,0)
        self.se = SELayer(512,512)
...
class BaseDecoder(nn.Module):
    def __init__(self):
        ...
        self.conv_up1 = nn.Conv2d(512, 32, 1)
        # self.conv_up2 = nn.Conv2d(32, 32, 1)
        # self.conv_up3 = nn.Conv2d(32, 32, 1)
        # self.conv_up4 = nn.Conv2d(32, 32, 1)
...
class MiniNet(nn.Module):
    def __init__(self, num_class):
        ...
        self.final_conv = nn.Conv2d(32, num_class, 1)
