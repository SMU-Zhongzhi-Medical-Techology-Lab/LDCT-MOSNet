...
class BaseEncoder(nn.Module):
    def __init__(self):
        ...
        self.block5 = InvertedResidualBlock(32,64,1,1)
        self.block6 = InvertedResidualBlock(64, 128, 1, 1)
        self.block7 = InvertedResidualBlock(128, 256, 1, 1)

        self.conv2 = nn.Conv2d(256,512,3,1,1)
        self.se1 = SELayer(16, 16)
        self.se2 = SELayer(32, 32)
        self.se3 = SELayer(256, 256)
        self.se4 = SELayer(512,512)
